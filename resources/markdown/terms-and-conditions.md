...
- **"Intellectual Property"** means all creative work, designs, code, strategies, and materials produced in the course of a project.

---

## 3. Engagement & Project Commencement
...
Upon commencement, the Client agrees to:

- Complete the Brand Intelligence Brief and/or any discovery forms in full and in good faith.
- Provide accurate, complete, and timely information required for the project.
- Identify and make available a single primary decision-maker with authority to approve work.
- Respond to review requests and approval requests within the timeframes specified in the Project Agreement.
...
All projects are invoiced in USD unless otherwise agreed in writing. Payments are structured as milestone-based instalments as defined in the Project Agreement. The standard structure is:

- **Deposit** (typically 40–50%) — due before project commencement.
- **Interim payment** (where applicable) — due at an agreed milestone.
- **Final balance** — due before final file delivery.
...
Each project includes a defined number of revision rounds as stated in the Project Agreement. Revisions are understood to mean refinements within an agreed creative direction — not changes to the brief, strategy, or direction established during discovery.
...
If the Client requests a fundamental change in creative direction after concepts have been presented — including but not limited to requesting an entirely new logo concept after a direction has been chosen and developed — this constitutes a scope change and will be treated as additional work.
...
Estimated timelines are provided in the Project Agreement and are contingent upon the timely provision of required information, feedback, and approvals by the Client.
...
In the event of a dispute, both parties agree to first attempt resolution through good-faith negotiation. If a resolution cannot be reached within 30 days, the matter may be referred to mediation before any formal legal proceedings are initiated.

These Terms are governed by the laws of the Federal Republic of Nigeria. For international clients, both parties agree to submit to the non-exclusive jurisdiction of Nigerian courts, without prejudice to either party's right to seek urgent relief in any other jurisdiction.
