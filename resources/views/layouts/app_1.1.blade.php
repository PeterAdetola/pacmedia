...
<head>
    ...
    <title>{{ $metaTitle ?? 'Pacmedia Creatives | Forging Identity. Engineering Digital Infrastructure' }}</title>
...
{{-- ================================================ --}}
{{-- NAVBAR — conditional on page type --}}
{{-- Pass $isHomePage = true from HomeController --}}
{{-- Inner pages omit it (defaults to false) --}}
{{-- ================================================ --}}
@if($isHomePage ?? false)
