<x-guest-layout title="Register">
    ...
    <x-auth-card>
        ...
        <p style="font-size: 0.875rem; color: var(--pac-ink-muted); margin: 0 0 1.6rem;">
            Join The Pacmedia. Fill in your details below.
        </p>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="pac-field">
                <input
                    ...
                    autofocus
                />
                <label class="pac-label" for="name">Full Name</label>
                @error('name')
            ...
            <button class="pac-btn" type="submit" data-pac-submit>
                <span class="pac-btn-text">Create Account</span>
            ...
            <div class="pac-socials">
                ...
                <a href="{{ route('auth.social.redirect', 'google') }}"
                   class="pac-social-btn" title="Continue with Google">
                ...
                <a href="{{ route('auth.social.redirect', 'linkedin') }}"
                   class="pac-social-btn" title="Continue with LinkedIn">
                ...
                <a href="{{ route('auth.social.redirect', 'github') }}"
                   class="pac-social-btn" title="Continue with GitHub">
                    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
