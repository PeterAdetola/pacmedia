            ...
            <script>
                $(function () {
                    ...
                    const ROUTES = {
                        ...
                        show:    '{{ url('admin/clients') }}',
                        update:  '{{ url('admin/clients') }}',
                        destroy: '{{ url('admin/clients') }}',
                        restore: '{{ url('admin/clients') }}',
                    };
                    ...
                    let table = $('#clientsTable').DataTable({
                        ...
                        columns: [
                            { data: 'id', defaultContent: '', orderable: false, searchable: false, render: () => '' },
                            {
                                data: 'name',
                    ...
                    $('#clientForm').off('submit').on('submit', function () {
                        clearErrors();
                        ...
                        $.ajax({
                            ...
                            error: function (xhr) {
                                if (xhr.status === 422) {
                                    ...
                                    Pac.toast.error('Something went wrong. Please try again.');
                                }
                            }
                        });
                    });
                    ...
                    $(document).on('click', '.btn-delete', function () {
                        ...
                        Pac.confirm({
                            ...
                            message: `"${name}" will be archived. They can be restored later.`,
                            icon:    'warning',
                            confirm: 'Yes, Archive',
                            cancel:  'Cancel',
