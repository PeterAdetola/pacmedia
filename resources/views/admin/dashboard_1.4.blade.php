<x-admin-layout title="Dashboard">
    ...
    @push('page-css')
        ...
        <style>
            ...
            .pac-radial-wrap { width: 90px; height: 90px; }
    ...
    ═══════════════════════════════════════════════════════ --}}
    <div class="row g-4 mb-4 pac-row-1 align-items-stretch">
        ...
        <div class="col-12 col-lg-7 d-flex gap-4">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <div class="d-flex align-items-center gap-2 flex-wrap">
                                <h5 class="mb-0 fw-800" style="font-size:1.5rem; letter-spacing:-0.03em; color:#111827;">
