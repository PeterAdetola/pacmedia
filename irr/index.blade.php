...
<head>
    ...
    <meta name="title" content="Pacmedia Creatives - Tactical Digital Solutions | Brand Strategy & Performance Engineering" />
    <meta name="description" content="Pacmedia Creatives deploys tactical digital solutions for ambitious companies worldwide. Expert brand identity systems, high-performance web development, and intelligent AI automation." />
    <meta name="keywords" content="Pacmedia Creatives, tactical digital solutions, brand strategy, brand identity design, performance web development, AI automation systems, custom web development, conversion-focused design, intelligent automation, digital presence strategy, UI/UX design, React development, brand architecture, global digital agency" />
    ...
    <meta property="og:description" content="Forging Digital Prestige. Brand strategy, performance engineering, and intelligent automation for companies that refuse to blend in." />
    ...
    <meta name="twitter:description" content="Forging Digital Prestige. Brand strategy, performance engineering, and intelligent automation for ambitious companies." />
    ...
    <script type="application/ld+json">
        ...
        "serviceType": ["Brand Strategy","Visual Identity Design","Web Development","AI Automation","Digital Marketing"],
        "priceRange": "$$"
    }
    </script>
                            ...
                            <div class="items__container">
                                ...
                                <div class="item icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
                                        <path d="M21.5,2H2.5C1.122,2,0,3.121,0,4.5V22H24V4.5c0-1.379-1.122-2.5-2.5-2.5ZM1,4.5c0-.827,.673-1.5,1.5-1.5h5.5V21H1V4.5ZM23,21H9V3h12.5c.827,0,1.5,.673,1.5,1.5V21ZM3,10h3v1H3v-1Zm0,4h3v1H3v-1ZM6,6v1H3v-1h3Z"/>
                                    </svg>
                                </div>
                            ...
                            <div class="content__block grid-block">
                                <div class="container-fluid p-0">
                                    <div class="row g-0 justify-content-between">
                                        ...
                                        <div class="col-12 col-md-4 col-xxl-3 grid-item about-info pre-grid d-none d-md-block">
                                            <div class="about-info__item animate-in-up">
                                                <h6>Direct Contact</h6>
                                            </div>
                                            <div class="about-info__item animate-in-up">
                                                <h6>
                                                    <a class="link-inline text-link" href="mailto:reach@thepacmedia.com?subject=Briefing%20Request">reach@thepacmedia.com</a>
                                                </h6>
                                            </div>
                                            <div class="about-info__item animate-in-up">
                                                <h6>
                                        ...
                                        <div class="row g-0">
                                            <div class="col-12">
                                                <div class="divider divider-video">
                                                    <video class="bg-video" autoplay loop muted playsinline poster="{{ asset('img/fallback.jpg') }}">
                            ...
                            <div class="content__block grid-block">
                                <div class="container-fluid p-0">
                                    <div class="row g-0 align-items-stretch cards">
                                        {{-- Service cards — pulled from services.md --}}
                                            ...
                                            <div class="col-12 col-md-6 cards__item grid-item animate-card-2">
                                                <div class="cards__card d-flex flex-column">
                                                    <div class="cards__descr">
                                                        <h3 class="cards__title animate-in-up">{!! nl2br(e($service['title'])) !!}</h3>
                                                        <p class="cards__text type-basic-160lh animate-in-up">{{ $service['description'] }}</p>
                                                    </div>
                                                    <div class="cards__image d-flex animate-in-up">
                                                        <img src="{{ asset('img/services/' . $service['image']) }}" alt="Service/Feature Image" />
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
                                    ...
                                    <div class="row g-0">
                                        <div class="col-12">
                                            <div class="content__block pre-grid-items">
                                                <div class="footer__link d-flex flex-column flex-md-row justify-content-md-between align-items-md-center">
                                                    <div class="footer__text reveal-type animate-in-up">
                                                        Skip the form?<br />Book a Call!
                                                    </div>
                                                    <div class="footer__btn animate-in-up">
                                                        <a href="mailto:reach@thepacmedia.com?subject=Briefing%20Request" class="btn btn-circle-icon hover-circle">
                                                            <em></em>
                                                    ...
                                                    <div class="row g-0">
                                                        <div class="col-12 col-lg-3 contact-data__item grid-item">
                                                            <a href="#home" class="footer-logo logo-text animate-in-up">
                                                                <span style="display: inline-block; width: 8em; padding-left: 0;">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 263.2 43.7" style="width: 100%; height: auto; display: block;" class="logo-svg-alt" aria-label="Text Logo">
                                                                        <style>
                                                                            .logo-svg-alt .logo-fill { fill: currentColor; }
                                                                            .logo-svg-alt .logo-dot { fill: #e6e117; }
                                                                        </style>
                                                                        <g>
                                                        ...
                                                        <div class="col-12 col-md-4 col-lg-4 contact-data__item grid-item">
                                                            ...
                                                            <p class="contact-data__text small type-basic-160lh">
                                                                ...
                                                                <a class="link-small-160lh animate-in-up" href="#services">Capabilities</a><br />
                                                                <a class="link-small-160lh animate-in-up" href="#contact">Let's talk</a>
                                                            </p>
                                                        </div>
                                                        <div class="col-12 col-md-4 col-lg-4 contact-data__item grid-item">
                                                            <p class="contact-data__title tagline-chapter animate-in-up">Copyright & Terms</p>
                                                            <p class="contact-data__text small type-basic-160lh">
                                                                <a class="link-small-160lh animate-in-up" href="#">Terms & Conditions</a><br />
                                                                <a class="link-small-160lh animate-in-up" href="#">Privacy policy</a>
                                                            </p><br/>
                                                            <p class="contact-data__text small type-basic-160lh">
                                                                <a class="link-small-160lh animate-in-up" href="mailto:reach@thepacmedia.com?subject=Briefing%20Request">reach@thepacmedia.com</a><br />
                                                            <div class="copyright" style="color: white; margin-top: 1em;">
                                                                &copy;<span id="current-year">{{ date('Y') }}</span> Pacmedia Creatives
                                                            </div>
                                                            </p>
                                                        </div>
                                                    </div>
